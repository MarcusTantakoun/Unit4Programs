...
public class InsertDeleteFruit {
    ...
    public static void main(String[] args) {
        ...
        showFruit(fruits);
        System.out.println("Inserting banana and rasberry");
        loc = findInsertPoint(fruits, "Banana");
        insert(fruits, "Banana", loc);
        loc = findInsertPoint(fruits, "Rasberry");
        insert(fruits, "Rasberry", loc);
        showFruit(fruits);
        /////////////Testing delete//////////////////////
        Scanner scan = new Scanner(System.in);
        String f;
        while (true) {
            System.out.println("Enter fruit to delete, or \"q\" to quit > ");
            f = scan.nextLine();
            if (f.equals("q")) {
                break;
            }
